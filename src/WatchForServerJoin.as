// https://github.com/XertroV/tm-better-room-manager/blob/9d643c2d932fd47dac9879ef8ab380c56beee301/src/WatchForServerJoin.as
namespace WatchServer {
    ...
    void _CheckRoomsForClub() {
        ...
        if (!doNotRefresh) {
            ...
            auto activities = API::GetClubActivities(clubId, true, 100, 0);
